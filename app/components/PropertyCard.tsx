...
export default function PropertyCard({
  ...
  const aspectRatio = variant === "tall" ? "aspect-[3/4]" : "aspect-square";
  ...
  return (
    <div className="flex-none w-[280px] group cursor-pointer">
      <div
        className={`relative ${aspectRatio} rounded-xl overflow-hidden mb-4 shadow-sm group-hover:shadow-xl transition-all duration-300`}
      >
        <div
